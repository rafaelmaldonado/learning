...
REPOS=(react-training aem-eds-training aem-cloud-migration japones claude-certified-architect learn-java-21-aem learn-aem-forms-backend learn-amazon-fba learn-aem-assets-professional learn-ai-in-aem)
